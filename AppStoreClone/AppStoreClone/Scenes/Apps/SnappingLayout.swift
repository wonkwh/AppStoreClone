...
//  AppStoreClone
//
//  Created by kwanghyun.won` on 2020/01/18.
...
class SnappingLayout: UICollectionViewFlowLayout {
    override func targetContentOffset(
        ...
        if proposedContentOffset.x <= 0 || collectionView.contentOffset == proposedContentOffset {
            ...
            nextX = collectionView.contentOffset
                .x + (velocity.x > 0 ? collectionView.bounds.size.width : -collectionView.bounds.size.width)
        }
