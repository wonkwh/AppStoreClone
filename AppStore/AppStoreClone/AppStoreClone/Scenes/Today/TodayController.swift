...
class TodayController: UICollectionViewController, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate {
    ...
    fileprivate func setupAppFullscreenStartingPosition(_ indexPath: IndexPath) {
        ...
        anchoredConstraints = fullscreenView.anchor(
            top: view.topAnchor,
    ...
    fileprivate func beginAnimationAppFullscreen() {
        UIView.animate(
            ...
            animations: {
                ...
                guard let cell = self.appFullscreenController.tableView.cellForRow(at: [0, 0]) as? AppFullscreenHeaderCell
                else { return }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        (cell as? TodayMultipleAppCell)?.multipleAppsController.collectionView
            .addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(handleMultipleAppsTap)))
